<?php
function register_rekapspp_main($arg=NULL, $nama=NULL) {
	...
	if ($cetakpdf=='pdf') {
		apbd_ExportPDF_P($output, 10, "Rekap Register SPP.pdf");
		...
		header( "Content-disposition: attachment; filename= Rekap_Register_SPP.xls" );
		...
		$output_form = drupal_get_form('register_rekapspp_main_form');	 
		
		$btn = l('Cetak', 'rekapregisterspp/filter/' . $bulan . '/' .  $kodeuk . '/pdf' , array ('html' => true, 'attributes'=> array ('class'=>'btn btn-primary')));
		$btn .= '&nbsp' . l('Excel', 'rekapregisterspp/filter/' . $bulan . '/' .  $kodeuk . '/excel' , array ('html' => true, 'attributes'=> array ('class'=>'btn btn-primary')));
...
function register_rekapspp_main_form_submit($form, &$form_state) {
	$bulan= $form_state['values']['bulan'];
	$kodeuk= $form_state['values']['kodeuk'];
	
	$uri = 'rekapregisterspp/filter/' . $bulan . '/' . $kodeuk;
	drupal_goto($uri);
	
}


function register_rekapspp_main_form($form, &$form_state) {
...
for ($n=0; $n<=8; $n++) {
	...
	if ($bulan>0) $sql->where('EXTRACT(MONTH FROM d.SPPtgl) <:month', array('month' => $bulan));
	$sql->condition('d.jenisdokumen', $n, '=');
	$sql->condition('d.sppok', '1', '='); 
	//$sql->condition('d.SPPno', '', '<>'); 
	$res = $sql->execute();
	foreach ($res as $data) {
		$lalu = $data->realisasi;
	...
	$SPP =  l($arr_dokumen[$n], 'cetakregisterSPP/' . $kodeuk . '/' . $bulan . '/##/' . $n . '/10/........./pdf', array('attributes' => array('class' => null)));

	$rows[] = array(
		array('data' => $n+1, 'align' => 'left', 'valign'=>'top'),
		array('data' => $SPP, 'align' => 'left', 'valign'=>'top'),
...
$rows[] = array(
		...
		array('data' => '<STRONG>TOTAL SPP</STRONG>', 'align' => 'left', 'valign'=>'top'),
...
$rows[] = array(
		array('data' => null, 'align' => 'left', 'valign'=>'top'),
		array('data' => '<STRONG>TOTAL SPP KAS</STRONG>', 'align' => 'left', 'valign'=>'top'),
...
$rows[] = array(
		array('data' => null, 'align' => 'left', 'valign'=>'top'),
		array('data' => '<STRONG>TOTAL SPP BELANJA</STRONG>', 'align' => 'left', 'valign'=>'top'),
		...
		$rows[] = array(
		array('data' => null, 'align' => 'left', 'valign'=>'top'),
		array('data' => '<STRONG>TOTAL SPP NIHIL</STRONG>', 'align' => 'left', 'valign'=>'top'),
...
$rows = array();
$rows[] = array(
	array('data' => 'LAPORAN REKAP SPP', 'width' => '510px', 'align'=>'center','style'=>'font-size:80%;border:none'),
);
if ($kodeuk=='ZZ') {
	$rows[] = array(
...
$header[] = array (
	...
	array('data' => 'SPP','width' => '145px', 'align'=>'center','style'=>'font-size:80%;border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-weight: bold'),
...
$header[] = array (
	...
	array('data' => 'SPP','width' => '145px', 'rowspan' => '2', 'align'=>'center','style'=>'font-size:80%;border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-weight: bold'),
...
$rows[] = array(
	...
	array('data' => '<strong>TOTAL SPP</strong>', 'width' => '145px', 'align'=>'left','style'=>'font-size:80%;border-right:1px solid black;border-top:1px solid black;'),
...
$rows[] = array(
	array('data' => null, 'width' => '20px', 'align'=>'left','style'=>'font-size:80%;border-left:1px solid black;border-top:1px solid black;border-right:1px solid black;'),
	array('data' => '<strong>TOTAL SPP KAS</strong>', 'width' => '145px', 'align'=>'left','style'=>'font-size:80%;border-right:1px solid black;border-top:1px solid black;'),
...
$rows[] = array(
	array('data' => null, 'width' => '20px', 'align'=>'left','style'=>'font-size:80%;border-left:1px solid black;border-top:1px solid black;border-right:1px solid black;'),
	array('data' => '<strong>TOTAL SPP BELANJA</strong>', 'width' => '145px', 'align'=>'left','style'=>'font-size:80%;border-right:1px solid black;border-top:1px solid black;'),
...
$rows[] = array(
	array('data' => null, 'width' => '20px', 'align'=>'left','style'=>'font-size:80%;border-left:1px solid black;border-top:1px solid black;border-right:1px solid black;'),
	array('data' => '<strong>TOTAL SPP NIHIL</strong>', 'width' => '145px', 'align'=>'left','style'=>'font-size:80%;border-right:1px solid black;border-top:1px solid black;'),

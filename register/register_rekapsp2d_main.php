<?php
function register_rekapsp2d_main($arg=NULL, $nama=NULL) {
	...
	if ($cetakpdf=='pdf') {
		apbd_ExportPDF_P($output, 10, "Rekap Register SP2D.pdf");
		...
		header( "Content-disposition: attachment; filename= Rekap_Register_SP2D.xls" );
		...
		$output_form = drupal_get_form('register_rekapsp2d_main_form');	 
		
		$btn = l('Cetak', 'rekapregister/filter/' . $bulan . '/' .  $kodeuk . '/pdf' , array ('html' => true, 'attributes'=> array ('class'=>'btn btn-primary')));
		$btn .= '&nbsp' . l('Excel', 'rekapregister/filter/' . $bulan . '/' .  $kodeuk . '/excel' , array ('html' => true, 'attributes'=> array ('class'=>'btn btn-primary')));
...
function register_rekapsp2d_main_form_submit($form, &$form_state) {
	$bulan= $form_state['values']['bulan'];
	$kodeuk= $form_state['values']['kodeuk'];
	
	$uri = 'rekapregister/filter/' . $bulan . '/' . $kodeuk;
	drupal_goto($uri);
	
}


function register_rekapsp2d_main_form($form, &$form_state) {
...
//SP2D = Belanja + Restitusi
$realisasi_t_sp2d = 0;
$lalu_t_sp2d = 0;
$ini_t_sp2d = 0;
$realisasi_t_sp2d_n = 0;
$lalu_t_sp2d_n = 0;
$ini_t_sp2d_n = 0;
...
for ($n=0; $n<=8; $n++) {
	...
	if (($n==0) or ($n==1) or ($n==2) or ($n==3) or ($n==4) or ($n==0)) {
		...
		//SP2D
		$lalu_t_sp2d_n += $lalu_n;
    	$ini_t_sp2d_n += $ini_n;
	    $realisasi_t_sp2d_n += $realisasi_n;
	    
	    $lalu_t_sp2d += $lalu;
    	$ini_t_sp2d += $ini;
	    $realisasi_t_sp2d += $realisasi;		
	}
	...
	$SP2D =  l($arr_dokumen[$n], 'cetakregisterskpd/' . $kodeuk . '/' . $bulan . '/##/' . $n . '/10/........./pdf', array('attributes' => array('class' => null)));

	$rows[] = array(
		array('data' => $n+1, 'align' => 'left', 'valign'=>'top'),
		array('data' => $SP2D, 'align' => 'left', 'valign'=>'top'),
...
$rows[] = array(
		...
		array('data' => '<STRONG>TOTAL SP2D</STRONG>&nbsp;<sub>Rekap seluruh SP2D termasuk Nihil, Restitusi dan PFK</sub>' , 'align' => 'left', 'valign'=>'top'),
...
$rows[] = array(
		array('data' => null, 'align' => 'left', 'valign'=>'top'),
		array('data' => '<STRONG>TOTAL SP2D KAS</STRONG>&nbsp;<sub>Rekap SP2D yang mengakibatkan pengkreditan Kas Daerah, dimana Nihil dan PFK tidak termasuk</sub>', 'align' => 'left', 'valign'=>'top'),
...
$rows[] = array(
		array('data' => null, 'align' => 'left', 'valign'=>'top'),
		array('data' => '<STRONG>TOTAL SP2D BELANJA</STRONG>&nbsp;<sub>Rekap SP2D yang menyebabkan terjadinya realisasi belanja, dimana UP/TU, PFK dan Restitusi tidak termasuk. Sedangkan Nihil termasuk.</sub>', 'align' => 'left', 'valign'=>'top'),
...
$rows[] = array(
		array('data' => null, 'align' => 'left', 'valign'=>'top'),
		array('data' => '<STRONG>TOTAL SP2D NIHIL</STRONG>&nbsp;<sub>Rekap SP2D Nihil, yaitu TU Nihil dan GU Nihil</sub>', 'align' => 'left', 'valign'=>'top'),
...
$rows[] = array(
		array('data' => null, 'align' => 'left', 'valign'=>'top'),
		array('data' => '<STRONG>TOTAL SP2D REGISTER</STRONG>&nbsp;<sub>Rekap SP2D sesuai dengan di Register, Kas + Restitusi</sub>', 'align' => 'left', 'valign'=>'top'),
		array('data' => '<STRONG>' . apbd_fn($lalu_t_sp2d_n) . '</STRONG>', 'align' => 'right', 'valign'=>'top'),
		array('data' => '<STRONG>' . apbd_fn($lalu_t_sp2d) . '</STRONG>', 'align' => 'right', 'valign'=>'top'),
		array('data' => '<STRONG>' . apbd_fn($ini_t_sp2d_n) . '</STRONG>', 'align' => 'right', 'valign'=>'top'),
		array('data' => '<STRONG>' . apbd_fn($ini_t_sp2d) . '</STRONG>', 'align' => 'right', 'valign'=>'top'),
		array('data' => '<STRONG>' . apbd_fn($realisasi_t_sp2d_n) . '</STRONG>', 'align' => 'right', 'valign'=>'top'),
		array('data' => '<STRONG>' . apbd_fn($realisasi_t_sp2d) . '</STRONG>', 'align' => 'right', 'valign'=>'top'),
	);	
//RENDER	
...
$rows = array();
$rows[] = array(
	array('data' => 'LAPORAN REKAP SP2D', 'width' => '510px', 'align'=>'center','style'=>'font-size:80%;border:none'),
);
if ($kodeuk=='ZZ') {
	$rows[] = array(
...
$header[] = array (
	...
	array('data' => 'SP2D','width' => '145px', 'align'=>'center','style'=>'font-size:80%;border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-weight: bold'),
...
$header[] = array (
	...
	array('data' => 'SP2D','width' => '145px', 'rowspan' => '2', 'align'=>'center','style'=>'font-size:80%;border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-weight: bold'),
...
$rows[] = array(
	...
	array('data' => '<strong>TOTAL SP2D</strong>', 'width' => '145px', 'align'=>'left','style'=>'font-size:80%;border-right:1px solid black;border-top:1px solid black;'),
...
$rows[] = array(
	array('data' => null, 'width' => '20px', 'align'=>'left','style'=>'font-size:80%;border-left:1px solid black;border-top:1px solid black;border-right:1px solid black;'),
	array('data' => '<strong>TOTAL SP2D KAS</strong>', 'width' => '145px', 'align'=>'left','style'=>'font-size:80%;border-right:1px solid black;border-top:1px solid black;'),
...
$rows[] = array(
	array('data' => null, 'width' => '20px', 'align'=>'left','style'=>'font-size:80%;border-left:1px solid black;border-top:1px solid black;border-right:1px solid black;'),
	array('data' => '<strong>TOTAL SP2D BELANJA</strong>', 'width' => '145px', 'align'=>'left','style'=>'font-size:80%;border-right:1px solid black;border-top:1px solid black;'),
...
$rows[] = array(
	array('data' => null, 'width' => '20px', 'align'=>'left','style'=>'font-size:80%;border-left:1px solid black;border-top:1px solid black;border-right:1px solid black;'),
	array('data' => '<strong>TOTAL SP2D NIHIL</strong>', 'width' => '145px', 'align'=>'left','style'=>'font-size:80%;border-right:1px solid black;border-top:1px solid black;'),

<?php
function register_pajak_main($arg=NULL, $nama=NULL) {
	$kodeuk = arg(1);
	$bulan = arg(2);
	$sumberdana = arg(3);
	$jenisdokumen=arg(4);
	...
	$output = getlaporanregister($kodeuk, $bulan, $tanggal,$jenisdokumen);
	if (arg(1)=='kegiatan') {
		$kodekeg = arg(2);
		...
		//$output_form = drupal_get_form('register_pajak_main_form');
...
function register_pajak_main_form($form, &$form_state) {
...
function register_pajak_main_form_validate($form, &$form_state) {
...
function register_pajak_main_form_submit($form, &$form_state) {
	$kodeuk = $form_state['values']['kodeuk'];
	...
	if($form_state['clicked_button']['#value'] == $form_state['values']['cetakpdf']){
		drupal_goto('cetakregisterpajak/' . $kodeuk . '/' . $bulan . '/' . $sumberdana . '/' . $jenisdokumen . '/' . $margin . '/'. $tanggal . '/pdf');
	} else if($form_state['clicked_button']['#value'] == $form_state['values']['cetak']){
		drupal_goto('cetakregisterpajak/' . $kodeuk . '/' . $bulan . '/' . $sumberdana . '/' . $jenisdokumen . '/' . $margin . '/'. $tanggal . '/cetak');
	} else if($form_state['clicked_button']['#value'] == $form_state['values']['cetakexcel']){
		drupal_goto('cetakregisterpajak/' . $kodeuk . '/' . $bulan . '/' . $sumberdana . '/' . $jenisdokumen . '/' . $margin . '/'. $tanggal . '/excel');
	}
}
...
function getlaporanregister($kodeuk, $bulan, $tanggal,$jenisdokumen){
	...
	$rows[]=array(
		array('data' => 'REGISTER PAJAK' . $labeljenis, 'width' => '875px','align'=>'center','style'=>'font-weight:bold;font-size:80%;'),
	);
	if (!isSuperuser()) {
		$rows[]=array(
	...
	$header=array(
		...
		array('data' => 'TANGGAL',  'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
		array('data' => 'NO. SP2D',  'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
		array('data' => 'SKPD', 'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
		array('data' => 'URAIAN', 'width' => '260px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
		array('data' => 'PENERIMA', 'width' => '120px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
		array('data' => 'PPN', 'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
		array('data' => 'PPH 21', 'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
		array('data' => 'PPH 22', 'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
		array('data' => 'PPH 23', 'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
		array('data' => 'PPH 4(2)', 'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black;font-size:70%;'),
	);
	...
	foreach($results as $data){
		...
		$rows[]=array(
			...
			array('data' => apbd_fd($data->sp2dtgl), 'width' => '60px','align'=>'center','style'=>'border-right:1px solid black;font-size:70%;'),
			array('data' => $data->sp2dno, 'width' => '60px','align'=>'center','style'=>'border-right:1px solid black;font-size:70%;'),
			array('data' => $data->namasingkat, 'width' => '60px','align'=>'left','style'=>'border-right:1px solid black;border-left:1px solid black;font-size:70%;'),
			array('data' => $keperluan, 'width' => '260px','align'=>'left','style'=>'border-right:1px solid black;border-left:1px solid black;font-size:70%;'),
			array('data' => '', 'width' => '120px','align'=>'right','style'=>'border-right:1px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-right:1px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-right:1px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-right:1px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-right:1px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-right:1px solid black;font-size:70%;'),
	...
	$rows[]=array(
			array('data' => 'JUMLAH', 'colspan' => '3','width' => '140px', 'cols-span'=>'3', 'align'=>'center','style'=>'border-top:1px solid black;border-left:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => $sumup+$sumgu+$sumtu+$sumgaji+$sumls+$sumnhl, 'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => apbd_fn($total), 'width' => '260px','align'=>'center','style'=>'border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '120px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
	...
	if($kodeuk == 'ZZ') {
		$results=db_query('SELECT d.jenisdokumen,COUNT(d.dokid) AS banyaknya,SUM(d.jumlah) AS total FROM  {dokumen} d WHERE  (MONTH(d.sp2dtgl) < :bulan) ' . $where . ' and (d.sp2dok=1) GROUP BY d.jenisdokumen',array(':bulan'=>$bulan));
	
	} else {
		$results=db_query('SELECT d.jenisdokumen,COUNT(d.dokid) AS banyaknya,SUM(d.jumlah) AS total FROM  {dokumen} d WHERE  (MONTH(d.sp2dtgl) < :bulan) ' . $where . ' and (d.sp2dok=1) and (d.kodeuk=:kodeuk) GROUP BY d.jenisdokumen', array(':bulan'=>$bulan, ':kodeuk'=>$kodeuk));
	}
	...
	$rows[]=array(
			array('data' => 'SEBELUMNYA', 'colspan' => '3','width' => '140px', 'cols-span'=>'3', 'align'=>'center','style'=>'border-top:1px solid black;border-left:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => $sumup_lalu+$sumgu_lalu+$sumtu_lalu+$sumgaji_lalu+$sumls_lalu+$sumnhl_lalu, 'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => apbd_fn($total_lalu), 'width' => '260px','align'=>'center','style'=>'border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '120px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
	...
	$rows[]=array(
			array('data' => 'KESELURUHAN', 'colspan' => '3','width' => '140px', 'cols-span'=>'3', 'align'=>'center','style'=>'border-top:1px solid black;border-left:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => ($sumup+$sumgu+$sumtu+$sumgaji+$sumls+$sumnhl) + ($sumup_lalu+$sumgu_lalu+$sumtu_lalu+$sumgaji_lalu+$sumls_lalu+$sumnhl_lalu), 'width' => '60px','align'=>'center','style'=>'border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => apbd_fn($total + $total_lalu), 'width' => '260px','align'=>'center','style'=>'border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '120px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
			array('data' => '', 'width' => '60px','align'=>'right','style'=>'border-top:1px solid black;border-right:1px solid black;border-bottom:2px solid black;font-size:70%;'),
...
function getlaporanregisterkegiatan($kodekeg){
	...
	$rows[]=array(
		array('data' => 'REGISTER PAJAK KEGIATAN' . $labeljenis, 'width' => '875px','align'=>'center','style'=>'font-weight:bold;font-size:80%;'),
	);
	$rows[]=array(
...
function getlaporanregister_pajak_backup($kodeuk, $bulan, $tanggal,$jenisdokumen){
	set_time_limit(0);
	ini_set('memory_limit','920M');
	...
	$rows[]=array(
		array('data' => 'REGISTER PAJAK', 'width' => '875px','align'=>'center','style'=>'font-weight:bold;font-size:80%;'),
	);
	if (!isSuperuser()) {
		$rows[]=array(
			array('data' => $namauk, 'width' => '875px','align'=>'center','style'=>'font-weight:bold;font-size:80%;'),

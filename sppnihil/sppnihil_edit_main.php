...
function sppnihil_edit_main($arg=NULL, $nama=NULL) {
	...
	if($print=='spp1') {			  
		...
		//$output .= theme('table', array('header' => $header, 'rows' => $rows ));
		//$output .= theme('pager');
		$output_form = drupal_get_form('sppnihil_edit_main_form');
		return drupal_render($output_form);// . $output;
	}		
	
}

function sppnihil_edit_main_form($form, &$form_state) {

	//FORM NAVIGATION	
	$current_url = url(current_path(), array('absolute' => TRUE));
	$referer = $_SERVER['HTTP_REFERER'];
	if ($current_url != $referer)
		$_SESSION["sppnihillastpage"] = $referer;
	else
		$referer = $_SESSION["sppnihillastpage"];
	...
	foreach ($results as $data) {
		...
		$title = 'SPP Nihil - ' . $data->keperluan ;
...
function sppnihil_edit_main_form_validate($form, &$form_state) {
...
//submitsppa21
	...
	/*
		...
		watchdog_exception('sppnihil-' . $nourut, $e);
	}
	*/
...
function printspp1($dokid){
	...
	$query->fields('d', array('dokid', 'sppno', 'spptgl', 'kodekeg', 'bulan', 'keperluan', 'jumlah',  
			'penerimanama', 'penerimabankrekening', 'penerimabanknama', 'penerimanpwp', 'penerimanip', 'spdno', 'jenisdokumen'));
	...
	foreach ($results as $data) {
		...
		$str_nihil = ($data->jenisdokumen=='5'? 'GU' : 'TU'); 
	}	
	...
	$rows[]=array(
		array('data' => 'SURAT PERMINTAAN PEMBAYARAN (SPP) ' . $str_nihil . ' NIHIL', 'width' => '510px','align'=>'center','style'=>'border:none;font-size:150%;font-weight:bold;text-decoration: underline;'),
	);
	$rows[]=array(
	...
	$rows[]=array(
		array('data' => 'PEMBAYARAN ' . $str_nihil . ' NIHIL [SPP-' . $str_nihil . ' NIHIL]', 'width' => '510px','align'=>'center','style'=>'border:1px solid black;'),
	);
	$rows[]=array(
...
function printspp2($dokid) {
	...
	$query->fields('d', array('dokid', 'sppok', 'sppno', 'spptgl', 'kodekeg', 'bulan', 'keperluan', 'jumlah',  
			'penerimanama', 'penerimabankrekening', 'penerimabanknama', 'penerimanpwp', 'penerimanip', 'spdno', 'pptknama', 'pptknip', 'penerimaalamat', 'penerimapimpinan', 'jenisdokumen'));
	...
	$rows[]=array(
		...
		array('data' => ':', 'width' => '10px','align'=>'left','style'=>'border:none;'),
		array('data' => 'BELANJAN '.$blj.' LANGSUNG', 'width' => '325px','align'=>'left','style'=>'border-right:1px solid black;'),
	...
	$rows[]=array(
		...
		array('data' => 'SP2D diminta', 'width' => '230px','align'=>'left','style'=>'border-right:1px solid black;'),
...
function printspp3($dokid){
	...
	$query->fields('d', array('dokid', 'sppno', 'spptgl', 'kodekeg', 'jumlah',  'penerimanama', 'penerimanip', 'jenisdokumen'));
	...
	$rows[]=array(
		array('data' => 'SURAT PERMINTAAN PEMBAYARAN (SPP) ' . $str_nihil . ' NIHIL', 'width' => '510px','align'=>'center','style'=>'border:none;font-size:150%;font-weight:bold;'),
	);
	$rows[]=array(
		array('data' => 'NOMOR : ' . $sppno, 'width' => '510px','align'=>'center','style'=>'border:none;font-size:130%;'),
	);
...
function printspp_kelengkapan($dokid){
	...
	$query->fields('d', array('sppno', 'jenisdokumen'));
	...
	$rows[]=array(
		array('data' => 'PEMBAYARAN ' . $str_nihil . ' NIHIL [SPP-' . $str_nihil . ' NIHIL]', 'width' => '510px','align'=>'left','style'=>'border:none;'),
	);
...
function printspp_pernyataan($dokid){
	...
	$query->fields('d', array('sppno', 'spptgl', 'jumlah', 'jenisdokumen'));
	...
	$rows[]=array(
		array('data' => 'SURAT PERNYATAAN PENGAJUAN ' . $str_nihil . ' NIHIL', 'width' => '510px','align'=>'center','style'=>'border:none;font-size:125%;font-weight:bold;text-decoration:underline;'),
	);
	$rows[]=array(
	...
	$rows[]=array(
		array('data' => 'Sehubungan dengan Surat Permintaan Pembayaran ' . $str_nihil . ' Nihil(' . $str_nihil . ' Nihil) yang kami ajukan sebesar Rp ' . 
	...
	$rows[]=array(
		...
		array('data' => ' Jumlah Pembayaran ' . $str_nihil . ' Nihil (' . $str_nihil . ' Nihil) tersebut diatas akan dipergunakan untuk keperluan guna membiayai kegiatan yang akan kami laksanakan sesuai dengan DPA-SKPD.', 'width' => '460px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => '2.', 'width' => '50px','align'=>'right','style'=>'border:none;'),
		array('data' => ' Jumlah Pembayaran ' . $str_nihil . ' Nihil (' . $str_nihil . ' Nihil) tersebut tidak akan digunakan untuk membiayai pengeluaran- pengeluaran yang menurut ketentuan yang berlaku harus dilakukan dengan Pembayaran Langsung.', 'width' => '460px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => 'Demikian surat keterangan ini dibuat untuk melengkapi persyaratan pengajuan Pembayaran ' . $str_nihil . ' Nihil (' . $str_nihil . ' Nihil) SKPD kami', 'width' => '510px','align'=>'left','style'=>'border:none;'),
	);
$rows[] = array(
					array('data' => '','width' => '255px', 'align'=>'center','style'=>'border:none;'),
					array('data' => 'Jepara, ' . $spptgl,'width' => '255px', 'align'=>'center','style'=>'border:none;'),
...
function printspp_keterangan($dokid){
	...
	$rows[]=array(
		array('data' => 'SURAT KETERANGAN PENGAJUAN SPP-' . $str_nihil . ' NIHIL', 'width' => '510px','align'=>'center','style'=>'border:none;font-size:125%;font-weight:bold;text-decoration:underline;'),
	);
	$rows[]=array(
		array('data' => 'Nomor : ' . $sppno, 'width' => '510px','align'=>'center','style'=>'border:none;'),
	);
	...
	$rows[]=array(
		array('data' => 'Demikian surat keterangan ini dibuat untuk melengkapi persyaratan pengajuan SPP-' . $str_nihil . ' NIHIL SKPD', 'width' => '510px','align'=>'left','style'=>'border:none;'),
	);
	$rows[] = array(
					array('data' => '','width' => '255px', 'align'=>'center','style'=>'border:none;'),
					array('data' => '','width' => '255px', 'align'=>'center','style'=>'border:none;'),

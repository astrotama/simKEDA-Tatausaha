<?php
function spptu_new_main($arg=NULL, $nama=NULL) {
	//drupal_add_css('files/css/textfield.css');
	
	$output_form = drupal_get_form('spptu_new_main_form');
	return drupal_render($output_form);// . $output;
	
}

function spptu_new_main_form($form, &$form_state) {
...
function spptu_new_main_form_submit($form, &$form_state) {
	...
	//try {
		...
		$query = db_insert('dokumen')
				->fields(array('dokid', 'bulan', 'jenisdokumen', 'kodeuk', 'sppno', 'spptgl', 'keperluan', 
								...
								'penerimabankrekening', 'penerimanpwp', 'kodebank'))
				->values(
					array(
						'dokid'=> $dokid,
						'bulan'=> $bulan,

...
function gantiuangspm_delete_form() {
    ...
    if (isset($dokid)) {
        ...
        if ($ada) {
			...
			//	$_SESSION["gantiuangspmlastpage"] = $referer;
			//else
			//	$referer = $_SESSION["gantiuangspmlastpage"];
...
function gantiuangspm_delete_form_validate($form, &$form_state) {
}
function gantiuangspm_delete_form_submit($form, &$form_state) {

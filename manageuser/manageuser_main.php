...
function manageuser_main($arg=NULL, $nama=NULL) {
	...
	if ($pdf=='pdf') {
		...
		foreach ($results as $data) {
			$no++;  
			$editlink = l('<span class="glyphicon glyphicon-file" aria-hidden="true"></span> Edit Role', '' , array ('html' => true, 'attributes'=> array ('class'=>'btn btn-primary btn-sm')));
		...
		//$btn .= apbd_button_chart('manageuser/chart/' . $bulan.'/##/jenis_rb');

<?php
function approvedcoba_main($arg=NULL, $nama=NULL) {
...
function approved_main_form($form, &$form_state) {
  ...
  ", 'inline');
	...
	$results = db_query("select d.dokid, d.spmno,d.spmtgl,d.keperluan,d.jumlah,d.approved,u.namasingkat from dokumen as d inner join unitkerja as u on d.kodeuk = u.kodeuk where d.spmok=1 and d.approved = 1 order by spmtgl asc limit 10");

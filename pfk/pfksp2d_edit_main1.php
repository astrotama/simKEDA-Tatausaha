...
function pfksp2d_edit_main_form($form, &$form_state) {
	...
	$query->fields('d', array('kodebank','dokid', 'spmno', 'sp2dno', 'sp2dtgl', 'kodekeg', 'bulan', 'keperluan', 'jumlah', 'potongan', 'netto', 
			'penerimanama', 'penerimabankrekening', 'penerimabanknama', 'penerimanpwp', 'pptknama', 'pptknip', 'sp2dok'));
	...
	foreach ($results as $data) {
		...
		if (is_null($data->sp2dtgl))
			$sp2dtgl = mktime(0,0,0,12,16,2016);
		else
...
function printsp2d($dokid) {
	...
	$rows[]=array(
		...
		array('data' => $spmno, 'width' => '268px','align'=>'left','style'=>'border:none;'),
		array('data' => 'Dari', 'width' => '100px','align'=>'left','style'=>'border:none;'),
		array('data' => ':', 'width' => '20px','align'=>'center','style'=>'border:none;'),
		array('data' => 'Kuasa BUD', 'width' => '65px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => 'Tanggal', 'width' => '130px','align'=>'left','style'=>'border:none;'),
		array('data' => ':', 'width' => '25px','align'=>'center','style'=>'border:none;'),
		array('data' => $spmtgl, 'width' => '268px','align'=>'left','style'=>'border:none;'),
		array('data' => 'Tahun Anggaran', 'width' => '100px','align'=>'left','style'=>'border:none;'),
		array('data' => ':', 'width' => '20px','align'=>'center','style'=>'border:none;'),
		array('data' => apbd_tahun(), 'width' => '65px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
	...
	foreach ($results as $data) {
		...
		$rows[]=array(
			array('data' => $n, 'width' => '40px','align'=>'center','style'=>'border-right:1px solid black;'),
			array('data' => '... ' . $data->kodero, 'width' => '110px','align'=>'left','style'=>'border-right:1px solid black;'),
...
function printsp2d2($dokid) {
	...
	$rows[]=array(
		...
		array('data' => '', 'width' => '55px','align'=>'left','style'=>'font-size:150%;border:none;'),

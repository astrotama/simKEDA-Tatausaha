<?php
function gubarusp2dcoba_edit_main($arg=NULL, $nama=NULL) {
		...
		*/
		...
		foreach ($results as $data) {
			...
			if ($batas>=$jumlah) {
				...
				$strkode = '<p style="color:red">' . $data->kodero . '</p>';
				$struraian = '<p style="color:red">' . $data->uraian . '</p>';
			...
			$form['wrapperkegiatan']['table']['sisa' . $i]= array(
				'#prefix' => '<td>',
				'#markup'=> $strsaldo, 
				'#suffix' => '</td></tr>',
			);			
		...
		$form['wrapperkegiatan']['table']['saldo' . $i]= array(
			'#prefix' => '<td>',

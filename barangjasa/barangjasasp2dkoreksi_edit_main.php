<?php
function barangjasasp2dkoreksi_edit_main($arg=NULL, $nama=NULL) {
	...
	if(arg(3)=='pdf'){			
		...
		*/
		...
		//$output .= theme('pager');
		//drupal_set_message();
		$output_form = drupal_get_form('barangjasasp2dkoreksi_edit_main_form');
		return drupal_render($output_form);// . $output;
	}		
	
}

function barangjasasp2dkoreksi_edit_main_form($form, &$form_state) {
...
function barangjasasp2dkoreksi_edit_main_form_validate($form, &$form_state) {
	
} 

function barangjasasp2dkoreksi_edit_main_form_submit($form, &$form_state) {

...
function barangjasaspm_delete_form() {
...
function barangjasaspm_delete_form_validate($form, &$form_state) {
}
function barangjasaspm_delete_form_submit($form, &$form_state) {

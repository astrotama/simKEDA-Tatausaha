<?php
function barangjasaspm_arsip_main($arg=NULL, $nama=NULL) {
	$qlike='';
	$limit = 10;
...
function barangjasaspm_arsip_main_form_submit($form, &$form_state) {
	...
	*/
	...
	$uri = 'barangjasaspmarsip/filter/' . $kodeuk . '/' . $bulan . '/' . $spmok ;
	drupal_goto($uri);
	
}


function barangjasaspm_arsip_main_form($form, &$form_state) {

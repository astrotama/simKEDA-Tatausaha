...
function sppgaji_delete_form_validate($form, &$form_state) {
}
function sppgaji_delete_form_submit($form, &$form_state) {
    if ($form_state['values']['confirm']) {
		...
		//dokumenpns
		$num = db_delete('dokumenpns')
		  ->condition('dokid', $dokid)
		  ->execute();

		//dokumenpotongan
		$num = db_delete('dokumenpotongan')
		  ->condition('dokid', $dokid)
		  ->execute();

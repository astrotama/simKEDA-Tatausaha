...
function sppgajiantrian_main($arg=NULL, $nama=NULL) {
	...
	if ($arg) {
		...
		if (isUserSKPD()) 
			...
			$kodeuk = $_SESSION["sppgajiantrian_kodeuk"];
			if ($kodeuk=='') $kodeuk = 'ZZ';
		}
		//$bulan = date('m');
		$bulan = $_SESSION["sppgajiantrian_bulan"];
		if ($bulan=='') $bulan = '1';
		
		$proses = $_SESSION["sppgajiantrian_proses"];
		if ($proses=='') $proses = 'ZZ';
	}
...
function sppgajiantrian_main_form_submit($form, &$form_state) {
	...
	*/
	...
	$_SESSION["sppgajiantrian_kodeuk"] = $kodeuk;
	$_SESSION["sppgajiantrian_bulan"] = $bulan;
	$_SESSION["sppgajiantrian_proses"] = $proses;

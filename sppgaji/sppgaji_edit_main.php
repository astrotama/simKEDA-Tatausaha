...
function sppgaji_edit_main_form($form, &$form_state) {
	...
	if ($jenisgaji=='4') {
		...
		$form['jenisgajiview'] = array(
			'#type' => 'textfield',
			'#title' =>  t('Jenis Gaji'),
			'#prefix' => '<div class="col-md-6">',
			'#suffix' => '</div>',			
			'#default_value' => 'TAMSIL',
		);		
	} else {
		$opt_gaji['0'] = 'Reguler';
	...
	*/
	...
	$form['formcetak_bawah']= array(
		...
		//CETAK BAWAH	
		$form['formcetak_bawah']['submitsppa21']= array(
			'#type' => 'submit',
...
$query = db_select('dokumen', 'd');
	...
	$rows[]=array(
		array('data' => ' &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; Yang bertanda tangan di bawah ini pejabat Penatausahaan Keuangan (PPK) ' . $namauk . ' menyatakan bahwa telah memverifikasi pengajuan pembayaran [SPP-LS GAJI TUNJANGAN] sebesar Rp ' . 

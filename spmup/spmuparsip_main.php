<?php
function spmuparsip_main($arg=NULL, $nama=NULL) {
	$qlike='';
	$limit = 10;
    add_session();
	...
	if ($arg) {
		...
		if (isUserSKPD()) 
			...
			if(!isset($_SESSION["spmuparsip_kodeuk"]))
				$_SESSION["spmuparsip_kodeuk"]='ZZ';
			$kodeuk = $_SESSION["spmuparsip_kodeuk"];
			//if ($kodeuk=='') $kodeuk = 'ZZ';
		}
		//$bulan = date('m');
		if(!isset($_SESSION["spmuparsip_bulan"]))
				$_SESSION["spmuparsip_bulan"]=date('m');
		$bulan = $_SESSION["spmuparsip_bulan"];
		//if ($bulan=='') $bulan = date('m');
		
		if(!isset($_SESSION["spmuparsip_jenisdokumen"]))
				$_SESSION["spmuparsip_jenisdokumen"]='ZZ';
		$jenisdokumen = $_SESSION["spmuparsip_jenisdokumen"];
		//if ($jenisdokumen=='') $jenisdokumen = 'ZZ';

		if(!isset($_SESSION["spmuparsip_spmok"]))
				$_SESSION["spmuparsip_spmok"]='ZZ';
		$spmok = $_SESSION["spmuparsip_spmok"];
		//if ($spmok=='') $spmok = 'ZZ';
	}
	...
	$output_form = drupal_get_form('spmuparsip_main_form');
	if (isSuperuser())
		$header = array (
...
function spmuparsip_main_form_submit($form, &$form_state) {
	...
	*/
	...
	$uri = 'spmuparsip/filter/' . $kodeuk . '/' . $bulan . '/' . $jenisdokumen . '/' . $spmok ;
	drupal_goto($uri);
	
}


function spmuparsip_main_form($form, &$form_state) {

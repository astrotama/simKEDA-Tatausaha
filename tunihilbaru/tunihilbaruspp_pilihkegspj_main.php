<?php
function tunihilbaruspp_pilihkegspj_main($arg=NULL, $nama=NULL) {
	//drupal_add_css('files/css/textfield.css');
	
	$output_form = drupal_get_form('tunihilbaruspp_pilihkegspj_main_form');
	return drupal_render($output_form);// . $output;
	
}

function tunihilbaruspp_pilihkegspj_main_form($form, &$form_state) {
...
function tunihilbaruspp_pilihkegspj_main_form_validate($form, &$form_state) {
...
function tunihilbaruspp_pilihkegspj_main_form_submit($form, &$form_state) {
	...
	if ($dokid=='usulan') {
		...
		drupal_goto('tunihilbaru/new/' . $kodekeg);

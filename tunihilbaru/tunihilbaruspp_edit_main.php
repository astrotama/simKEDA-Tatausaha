...
function tunihilbaruspp_edit_main($arg=NULL, $nama=NULL) {
	...
	if($print=='spp1') {			  
		...
		//$output .= theme('table', array('header' => $header, 'rows' => $rows ));
		//$output .= theme('pager');
		$output_form = drupal_get_form('tunihilbaruspp_edit_main_form');
...
function tunihilbaruspp_edit_main_form($form, &$form_state) {

	//FORM NAVIGATION	
	$current_url = url(current_path(), array('absolute' => TRUE));
	$referer = $_SERVER['HTTP_REFERER'];
	if ($current_url != $referer)
		$_SESSION["tunihilspplastpage"] = $referer;
	else
		$referer = $_SESSION["tunihilspplastpage"];
	...
	foreach ($results as $data) {
		...
		$title = 'SPP TU Nihil ' . $data->keperluan ;
...
function tunihilbaruspp_edit_main_form_validate($form, &$form_state) {
...
//submitsppa21
	...
	drupal_goto('tunihilbaruspp/cetak/' . $dokid);
...
function printspp_1($dokid){
	...
	$query->fields('uk', array('kodeuk', 'kodedinas', 'namauk', 'header1','bendaharaatasnama', 'bendaharanama', 'bendaharanip'));
	...
	$rows[]=array(
		array('data' => 'PEMBAYARAN TU NIHIL [SPP-TU NIHIL]', 'width' => '510px','align'=>'center','style'=>'border:1px solid black;'),
	);
	$rows[]=array(
...
function printspp_2($dokid) {
	...
	$query->fields('uk', array('kodeuk', 'pimpinannama','bendaharaatasnama', 'kodedinas', 'namauk', 'header1', 'bendaharanama', 'bendaharanip'));
	...
	foreach ($res_keg as $data_keg) {
		...
		//$results = db_query('select sum(d.jumlah) as sudahcair from dokumen as d inner join ')
		...
		$rows[]=array(
			...
			array('data' => 'SP2D TU diminta', 'width' => '230px','align'=>'left','style'=>'border-right:1px solid black;border-bottom:1px solid black;'),
...
function printspp_2_lama($dokid, $kodekeg) {
	...
	$rows[]=array(
		...
		array('data' => 'SP2D TU diminta', 'width' => '230px','align'=>'left','style'=>'border-right:1px solid black;'),
...
function printspp_kelengkapan($dokid){
	...
	$rows[]=array(
		array('data' => 'PEMBAYARAN TU NIHIL [SPP-TU NIHIL]', 'width' => '510px','align'=>'left','style'=>'border:none;'),
	);
...
function printspp_pernyataan_ppk_baru($dokid){
	...
	$rows[]=array(
		array('data' => ' &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; Yang bertanda tangan di bawah ini pejabat Penatausahaan Keuangan (PPK) ' . $namauk . ' menyatakan bahwa telah memverifikasi pengajuan pembayaran [SPP-TU NIHIL] sebesar Rp ' . 
...
/*
	...
	$rows[]=array(
		array('data' => 'SURAT PERNYATAAN PENGAJUAN [SPP-TU NIHIL]', 'width' => '510px','align'=>'center','style'=>'border:none;font-size:125%;font-weight:bold;text-decoration:underline;'),
	);
	$rows[]=array(
		array('data' => 'Nomor : ' . $sppno, 'width' => '510px','align'=>'center','style'=>'border:none;'),
	);
	...
	$rows[]=array(
		array('data' => '   &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; Yang bertanda tangan di bawah ini Pejabat Penatausahaan Keuangan (PPK) ' . $namauk . ' Kabupaten Jepara menyatakan bahwa telah memverifikasi PENGAJUAN [SPP-TU NIHIL] sebesar ' . 
...
function printspp_pernyataan_ppk($dokid){
	...
	$rows[]=array(
		array('data' => 'Sehubungan dengan Surat Permintaan Pembayaran TU NIHIL [SPP-TU NIHIL] yang kami ajukan sebesar Rp ' . 
	...
	$rows[]=array(
		array('data' => '1.', 'width' => '50px','align'=>'right','style'=>'border:none;'),
		array('data' => ' Jumlah Pembayaran TU NIHIL [SPP-TU NIHIL] tersebut diatas akan dipergunakan untuk keperluan guna membiayai kegiatan yang akan kami laksanakan sesuai dengan DPA-SKPD.', 'width' => '460px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => '2.', 'width' => '50px','align'=>'right','style'=>'border:none;'),
		array('data' => ' Jumlah Pembayaran TU NIHIL [SPP-TU NIHIL] tersebut tidak akan digunakan untuk membiayai pengeluaran- pengeluaran yang menurut ketentuan yang berlaku harus dilakukan dengan Pembayaran Langsung.', 'width' => '460px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => 'Demikian surat keterangan ini dibuat untuk melengkapi persyaratan pengajuan Pembayaran TU NIHIL [SPP-TU NIHIL] SKPD kami', 'width' => '510px','align'=>'left','style'=>'border:none;'),
	);
	$rows[] = array(
					array('data' => '','width' => '255px', 'align'=>'center','style'=>'border:none;'),
					array('data' => '','width' => '255px', 'align'=>'center','style'=>'border:none;'),
...
function printspp_pernyataan($dokid){
	...
	$rows[]=array(
		array('data' => 'Sehubungan dengan Surat Permintaan [SPP-TU NIHIL] yang kami ajukan sebesar Rp ' . 
	...
	$rows[]=array(
		array('data' => '1.', 'width' => '50px','align'=>'right','style'=>'border:none;'),
		array('data' => ' Jumlah Pembayaran [SPP-TU NIHIL] tersebut diatas akan dipergunakan untuk keperluan guna membiayai kegiatan yang akan kami laksanakan sesuai dengan DPA-SKPD.', 'width' => '460px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => '2.', 'width' => '50px','align'=>'right','style'=>'border:none;'),
		array('data' => ' Jumlah Pembayaran [SPP-TU NIHIL] tersebut tidak akan digunakan untuk membiayai pengeluaran- pengeluaran yang menurut ketentuan yang berlaku harus dilakukan dengan Pembayaran Langsung.', 'width' => '460px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => 'Demikian surat keterangan ini dibuat untuk melengkapi persyaratan pengajuan Pembayaran [SPP-TU NIHIL] SKPD kami', 'width' => '510px','align'=>'left','style'=>'border:none;'),
	);
$rows[] = array(
					array('data' => '','width' => '255px', 'align'=>'center','style'=>'border:none;'),
					array('data' => 'Jepara, ' . $spptgl,'width' => '255px', 'align'=>'center','style'=>'border:none;'),
...
function printspp_keterangan($dokid){
	...
	$rows[]=array(
		array('data' => 'SURAT KETERANGAN PENGAJUAN [SPP-TU NIHIL]', 'width' => '510px','align'=>'center','style'=>'border:none;font-size:125%;font-weight:bold;text-decoration:underline;'),
	);
	$rows[]=array(
		array('data' => 'Nomor : ' . $sppno, 'width' => '510px','align'=>'center','style'=>'border:none;'),
	);
	...
	$rows[]=array(
		array('data' => 'Sehubungan dengan Surat Permintaan Pembayaran [SPP-TU NIHIL] yang kami ajukan sebesar Rp ' . 
	...
	$rows[]=array(
		array('data' => 'Demikian surat keterangan ini dibuat untuk melengkapi persyaratan pengajuan [SPP-TU NIHIL] SKPD', 'width' => '510px','align'=>'left','style'=>'border:none;'),
	);
	$rows[] = array(
					array('data' => '','width' => '255px', 'align'=>'center','style'=>'border:none;'),
					array('data' => '','width' => '255px', 'align'=>'center','style'=>'border:none;'),

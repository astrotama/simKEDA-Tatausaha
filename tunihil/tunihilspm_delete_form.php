...
function tunihilspm_delete_form() {
    ...
    if (isset($dokid)) {
        ...
        if ($ada) {
			...
			//	$_SESSION["tunihilspmlastpage"] = $referer;
			//else
			//	$referer = $_SESSION["tunihilspmlastpage"];
...
function tunihilspm_delete_form_validate($form, &$form_state) {
}
function tunihilspm_delete_form_submit($form, &$form_state) {

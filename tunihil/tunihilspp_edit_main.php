...
function tunihilspp_edit_main($arg=NULL, $nama=NULL) {
	...
	if($print=='spp1') {			  
		...
		//$output .= theme('table', array('header' => $header, 'rows' => $rows ));
		//$output .= theme('pager');
		$output_form = drupal_get_form('tunihilspp_edit_main_form');
		return drupal_render($output_form);// . $output;
	}		
	
}

function tunihilspp_edit_main_form($form, &$form_state) {
...
function tunihilspp_edit_main_form_validate($form, &$form_state) {
...
if($form_state['clicked_button']['#value'] == $form_state['values']['submitspp1']) {
	...
	drupal_goto('tunihilspp/edit/' . $dokid . '/ket');
...
function printspp_1($dokid){
	...
	$query->fields('d', array('dokid', 'sppno', 'spptgl', 'kodekeg', 'bulan', 'keperluan', 'jumlah',  
			'penerimanama', 'penerimabankrekening', 'penerimabanknama', 'penerimanpwp', 'penerimanip', 'spdno', 'pptknama', 'pptknip'));
...
function printspp_2($dokid) {
	...
	$rows[]=array(
		...
		array('data' => ':', 'width' => '10px','align'=>'left','style'=>'border:none;'),
		array('data' => 'BELANJAN LANGSUNG', 'width' => '325px','align'=>'left','style'=>'border-right:1px solid black;'),
	...
	$rows[]=array(
		...
		array('data' => 'SP2D TU Nihil diminta', 'width' => '230px','align'=>'left','style'=>'border-right:1px solid black;'),
...
function printspp_pernyataan($dokid){
	...
	$rows[]=array(
		array('data' => 'Sehubungan dengan Surat Permintaan TU Nihil (UP) yang kami ajukan sebesar Rp ' . 
	...
	$rows[]=array(
		...
		array('data' => ' Jumlah Pembayaran TU Nihil tersebut diatas akan dipergunakan untuk keperluan guna membiayai kegiatan yang akan kami laksanakan sesuai dengan DPA-SKPD.', 'width' => '460px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => '2.', 'width' => '50px','align'=>'right','style'=>'border:none;'),
		array('data' => ' Jumlah Pembayaran TU Nihil tersebut tidak akan digunakan untuk membiayai pengeluaran- pengeluaran yang menurut ketentuan yang berlaku harus dilakukan dengan Pembayaran Langsung.', 'width' => '460px','align'=>'left','style'=>'border:none;'),
	);
	$rows[]=array(
		array('data' => 'Demikian surat keterangan ini dibuat untuk melengkapi persyaratan pengajuan Pembayaran TU Nihil SKPD kami', 'width' => '510px','align'=>'left','style'=>'border:none;'),
	);
$rows[] = array(
					array('data' => '','width' => '255px', 'align'=>'center','style'=>'border:none;'),
					array('data' => 'Jepara, ' . $spptgl,'width' => '255px', 'align'=>'center','style'=>'border:none;'),
...
function printspp_keterangan($dokid){
	...
	$rows[]=array(
		array('data' => 'Sehubungan dengan Surat Permintaan TU Nihil yang kami ajukan sebesar Rp ' . 
